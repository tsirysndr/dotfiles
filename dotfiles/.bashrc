...
eval "$(oh-my-posh init bash --config ~/.oh-my-posh/themes/tokyonight_storm.omp.json)"

export NVM_DIR="$HOME/.config/nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion

alias utodocker="$HOME/Documents/gitlab/utocat/catalizr/utocat-tools-docker-project-orchestrator/scripts/entry-point.sh"
...
[[ -f ~/.local/share/rtx/bin/rtx ]] && eval "$($HOME/.local/share/rtx/bin/rtx activate bash)"
